                                ...
                                <div className="rule-card-control">
                                  ...
                                  {def.description && (
                                    <button
                                      ...
                                      onClick={(e) => { e.stopPropagation(); setActiveRuleTooltip(activeRuleTooltip === key ? null : key); }}
                    ...
                    {player?.id === room.hostId && (
                      <div className="rule-card-wrapper">
                        ...
                        >
                          ...
                          <div className="rule-card-control">
                            <div className={`rule-toggle-pill ${(room.settings?.winOnAbandonment ?? true) ? 'on' : 'off'}`}>
                              <div className="rule-toggle-knob" />
                            </div>
                            <button
                              className={`rule-help-btn ${activeRuleTooltip === 'winOnAbandonment' ? 'active' : ''}`}
                              onClick={(e) => { e.stopPropagation(); setActiveRuleTooltip(activeRuleTooltip === 'winOnAbandonment' ? null : 'winOnAbandonment'); }}
                              title="About this rule"
                            >?</button>
                          </div>
                        </div>
                        {activeRuleTooltip === 'winOnAbandonment' && (
                          <div className="rule-tooltip-panel">Declare the remaining connected player as the winner if all other players disconnect during the match.</div>
                        )}
                      </div>
                    )}
                  </div>
